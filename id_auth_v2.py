...
VERSION 2: Allows you to pick up where you left off and saves information intermediately  
"""
    ...
    for item in data:
        ...
        for ref in (
            ...
            for author_name in authors:
                ...
                # ---------------------------------------------------
                # Check whether this author was already processed.
                # If so, skip the OpenAlex lookup.
                # ---------------------------------------------------

                identified_authors = ref.setdefault(
                    "identified_authors",
                    [],
                )
                ...
                # ---------------------------------------------------
                # Save immediately so the script can resume if
                # interrupted.
                # ---------------------------------------------------
